...
///////////////////////////////////////////////////////////////////////////////////////////
    ...
    var proryv2L = function() {
        var layer = new ymaps.Layer('http://vnr.github.io/wwii-maps/maps/burcevo/Z%z/%y/%x.png', {
//      var layer = new ymaps.Layer('http://vnr.github.io/aprmaps/img/wwii-burzevo/Z%z/%y/%x.png', {
            projection: ymaps.projection.sphericalMercator,
            tileTransparent: true
        });
        layer.getCopyrights = function() {
